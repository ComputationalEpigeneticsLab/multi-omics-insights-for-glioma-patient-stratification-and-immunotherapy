A <- read.table ("/home/yujiaxin/ribo-seq/3_RibORF/3_ribORF2/v4_r11/P1840/input.parameters.txt", sep="\t", header=T)
...
write.table (summary(pred)$coefficients, "/home/yujiaxin/ribo-seq/3_RibORF/3_ribORF2/v4_r11/P1840/model.parameters.txt", sep="	", quote=F)
save(pred, file = "/home/yujiaxin/ribo-seq/3_RibORF/3_ribORF2/v4_r11/P1840/model.rda")
E1 <- predict(pred, T2)
E2 <- cbind(E1, T2$gr)
a <- seq(-0.5,1.5,0.005)
fpr <- array()
...
pdf (file="/home/yujiaxin/ribo-seq/3_RibORF/3_ribORF2/v4_r11/P1840/plot.ROC.curve.pdf")
...
write.table (out, "/home/yujiaxin/ribo-seq/3_RibORF/3_ribORF2/v4_r11/P1840/stat.cutoff.txt", sep="\t", quote=F, row.names=F)
pred.pvalue <- sprintf("%.4f", predict(pred, A))
out2 <- data.frame(cbind(A, pred.pvalue))
write.table (out2, "/home/yujiaxin/ribo-seq/3_RibORF/3_ribORF2/v4_r11/P1840/pred.pvalue.parameters.txt", sep="\t", quote=F, row.names=F)
